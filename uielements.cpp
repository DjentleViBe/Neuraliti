...
ImVec4 clear_color = ImVec4(0.7803f, 0.8039f, 0.8745f, 1.00f);
GLFWwindow* window;
...
void Displayloop(char **argv){
    ...
    {   
        ...
        // 0. Main window for background
        ImGui::Begin("GENT Window", &show_main_window);
        ImGui::SetWindowSize(ImVec2(window_width / 2, window_height / 3));
        ImGui::SetWindowPos(ImVec2(window_width / 2, window_height / 1.6));
        ImGui::End();
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Begin("GENT world!");                          // Create a window called "Hello, world!" and append into it.

            ImGui::Text("This is some useful text.");               // Display some text (you can use a format strings too)
            ImGui::Checkbox("GENT Window", &show_demo_window);      // Edit bools storing our window open/close state
